  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        range_start: cn("bg-primary/15 rounded-l-full", defaultClassNames.range_start),
        range_middle: cn("bg-primary/15", defaultClassNames.range_middle),
        range_end: cn("bg-primary/15 rounded-r-full", defaultClassNames.range_end),
        today: cn(
