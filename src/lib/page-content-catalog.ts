...
const SRC: Record<string, Group> = {
  ...
  "/config-item": {
    ...
    fields: [["field-item-code", "Item Code"], ["field-item-name", "Item Name"], ["field-item-type", "Item Type"], ["field-category", "Category"], ["field-sub-category", "Sub Category"], ["field-primary-uom", "Primary UOM"], ["field-reorder-level", "Reorder Level"], ["field-expiry-date", "Expiry Date"], ["field-stock-threshold", "Stock Threshold (%)"], ["field-office", "Office"], ["field-warehouse", "Warehouse"], ["field-bin-location", "Bin Location"], ["field-stock-tracking", "Stock Tracking"], ["field-allocation-method", "Allocation Method"]],
