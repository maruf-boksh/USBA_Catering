  ...
  const packagingItems: ApprovalItem[] = useMemo(() => {
    return packagingBatches.map((b) => {
      ...
      return {
        ...
        fields: [
          { label: "Production ID", value: b.batch },
          { label: "Item", value: b.item },
          { label: "Qty", value: b.qty > 0 ? `${b.qty.toLocaleString()} portions` : "—" },
          ...
          { label: "Packaged At", value: b.packagedAt ?? "—" },
          { label: "Dispatch Ref", value: b.dispatchId ?? "—" },
