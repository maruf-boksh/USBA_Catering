...
export function WorkflowProvider({ children }: { children: ReactNode }) {
  ...
  const initialProductionEntries: WfProductionEntry[] = [
    ...
    // ── Wednesday Breakfast menu (meal-5) cooked for the 2026-05-20 scheduled
    // flights. These are the runs a delayed flight can be fed from: the meals
    // are finished and QC-passed but still held on the production floor, which
    // is why `inventoryAdded` is false — they were never booked into store, so
    // they carry no stock-ledger movement and the delay's Stock Availability
    // check still reads them as "Not In Stock". Hot Kitchen and Cold Kitchen
    // both feature so a single pull can span two sending warehouses.
    // Vegetable Sandwich is deliberately short of a 188-pax flight to exercise
    // the partial-coverage path.
    { id: "PRO-2026-000051", date: "2026-05-20", bom: "Paratha",            outputItemName: "Paratha",            outputItemCode: "FG-PRT", orderQty: 270, producedQty: 270, status: "Completed", qcCheckedBy: "F. Begum",     qcPassedAt: "2026-05-20 06:20", completedAt: "2026-05-20 06:25", officeId: "OFF-001", warehouseId: "WH-003", servesOrderNos: ["ORD-3410", "ORD-3411"] },
    { id: "PRO-2026-000052", date: "2026-05-20", bom: "Channa Masala",      outputItemName: "Channa Masala",      outputItemCode: "FG-CHM", orderQty: 270, producedQty: 260, status: "Completed", qcCheckedBy: "F. Begum",     qcPassedAt: "2026-05-20 06:35", completedAt: "2026-05-20 06:40", officeId: "OFF-001", warehouseId: "WH-003", servesOrderNos: ["ORD-3410", "ORD-3411"] },
    { id: "PRO-2026-000053", date: "2026-05-20", bom: "Boiled Egg",         outputItemName: "Boiled Egg",         outputItemCode: "FG-BEG", orderQty: 300, producedQty: 300, status: "Completed", qcCheckedBy: "Hygiene Lead", qcPassedAt: "2026-05-20 05:55", completedAt: "2026-05-20 06:00", officeId: "OFF-001", warehouseId: "WH-003", servesOrderNos: ["ORD-3410", "ORD-3411", "ORD-3412"] },
    { id: "PRO-2026-000054", date: "2026-05-20", bom: "Vegetable Sandwich", outputItemName: "Vegetable Sandwich", outputItemCode: "FG-VSW", orderQty: 140, producedQty: 120, status: "Completed", qcCheckedBy: "T. Islam",     qcPassedAt: "2026-05-20 07:05", completedAt: "2026-05-20 07:10", officeId: "OFF-001", warehouseId: "WH-004", servesOrderNos: ["ORD-3412"] },
    { id: "PRO-2026-000055", date: "2026-05-20", bom: "Fruit Salad",        outputItemName: "Fruit Salad",        outputItemCode: "FG-FRS", orderQty: 200, producedQty: 200, status: "Completed", qcCheckedBy: "T. Islam",     qcPassedAt: "2026-05-20 07:20", completedAt: "2026-05-20 07:25", officeId: "OFF-001", warehouseId: "WH-004", servesOrderNos: ["ORD-3412", "ORD-3413"] },
    // Thursday Lunch menu cooked for the 2026-05-21 flights (BS-411 · ORD-3425).
    { id: "PRO-2026-000061", date: "2026-05-21", bom: "Steamed Rice",       outputItemName: "Steamed Rice",       orderQty: 320, producedQty: 320, status: "Completed", qcCheckedBy: "F. Begum",     qcPassedAt: "2026-05-21 09:10", completedAt: "2026-05-21 09:15", officeId: "OFF-001", warehouseId: "WH-003", servesOrderNos: ["ORD-3425"] },
    { id: "PRO-2026-000062", date: "2026-05-21", bom: "Grilled Chicken",    outputItemName: "Grilled Chicken",    orderQty: 320, producedQty: 300, status: "Completed", qcCheckedBy: "F. Begum",     qcPassedAt: "2026-05-21 09:30", completedAt: "2026-05-21 09:35", officeId: "OFF-001", warehouseId: "WH-003", servesOrderNos: ["ORD-3425"] },
    { id: "PRO-2026-000063", date: "2026-05-21", bom: "Mixed Veg Curry",    outputItemName: "Mixed Veg Curry",    orderQty: 280, producedQty: 280, status: "Completed", qcCheckedBy: "T. Islam",     qcPassedAt: "2026-05-21 09:45", completedAt: "2026-05-21 09:50", officeId: "OFF-001", warehouseId: "WH-003", servesOrderNos: ["ORD-3425"] },
    { id: "PRO-2026-000064", date: "2026-05-21", bom: "Vegetable Biryani",  outputItemName: "Vegetable Biryani",  orderQty: 200, producedQty: 200, status: "Completed", qcCheckedBy: "T. Islam",     qcPassedAt: "2026-05-21 10:05", completedAt: "2026-05-21 10:10", officeId: "OFF-001", warehouseId: "WH-003", servesOrderNos: ["ORD-3425"] },
    { id: "PRO-2026-000065", date: "2026-05-21", bom: "Fish Curry",         outputItemName: "Fish Curry",         orderQty: 180, producedQty: 140, status: "Completed", qcCheckedBy: "Hygiene Lead", qcPassedAt: "2026-05-21 10:20", completedAt: "2026-05-21 10:25", officeId: "OFF-001", warehouseId: "WH-003", servesOrderNos: ["ORD-3425"] },
    { id: "PRO-2026-000066", date: "2026-05-21", bom: "Raita",              outputItemName: "Raita",              orderQty: 300, producedQty: 300, status: "Completed", qcCheckedBy: "T. Islam",     qcPassedAt: "2026-05-21 10:30", completedAt: "2026-05-21 10:35", officeId: "OFF-001", warehouseId: "WH-004", servesOrderNos: ["ORD-3425"] },
    // Friday Lunch menu cooked for the 2026-05-22 flights (BG-521 · ORD-3426).
    { id: "PRO-2026-000071", date: "2026-05-22", bom: "Kashmiri Polao",     outputItemName: "Kashmiri Polao",     orderQty: 300, producedQty: 300, status: "Completed", qcCheckedBy: "F. Begum",     qcPassedAt: "2026-05-22 09:05", completedAt: "2026-05-22 09:10", officeId: "OFF-001", warehouseId: "WH-003", servesOrderNos: ["ORD-3426"] },
    { id: "PRO-2026-000072", date: "2026-05-22", bom: "Beef Kala Bhuna",    outputItemName: "Beef Kala Bhuna",    orderQty: 300, producedQty: 260, status: "Completed", qcCheckedBy: "F. Begum",     qcPassedAt: "2026-05-22 09:25", completedAt: "2026-05-22 09:30", officeId: "OFF-001", warehouseId: "WH-003", servesOrderNos: ["ORD-3426"] },
    { id: "PRO-2026-000073", date: "2026-05-22", bom: "Masoor Dal",         outputItemName: "Masoor Dal",         orderQty: 280, producedQty: 280, status: "Completed", qcCheckedBy: "T. Islam",     qcPassedAt: "2026-05-22 09:40", completedAt: "2026-05-22 09:45", officeId: "OFF-001", warehouseId: "WH-003", servesOrderNos: ["ORD-3426"] },
    { id: "PRO-2026-000074", date: "2026-05-22", bom: "Steamed Rice",       outputItemName: "Steamed Rice",       orderQty: 260, producedQty: 260, status: "Completed", qcCheckedBy: "F. Begum",     qcPassedAt: "2026-05-22 09:55", completedAt: "2026-05-22 10:00", officeId: "OFF-001", warehouseId: "WH-003", servesOrderNos: ["ORD-3426"] },
    { id: "PRO-2026-000075", date: "2026-05-22", bom: "Lemon Grilled Fish", outputItemName: "Lemon Grilled Fish", orderQty: 200, producedQty: 160, status: "Completed", qcCheckedBy: "Hygiene Lead", qcPassedAt: "2026-05-22 10:10", completedAt: "2026-05-22 10:15", officeId: "OFF-001", warehouseId: "WH-003", servesOrderNos: ["ORD-3426"] },
    { id: "PRO-2026-000076", date: "2026-05-22", bom: "Sauteed Vegetables", outputItemName: "Sauteed Vegetables", orderQty: 240, producedQty: 240, status: "Completed", qcCheckedBy: "T. Islam",     qcPassedAt: "2026-05-22 10:20", completedAt: "2026-05-22 10:25", officeId: "OFF-001", warehouseId: "WH-004", servesOrderNos: ["ORD-3426"] },
  ];
