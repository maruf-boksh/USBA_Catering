...
const MAP: Record<string, string> = {
  ...
  complete:              "bg-[#ECFDF5] text-[#059669] border border-[#A7F3D0]",
  "full order":          "bg-[#ECFDF5] text-[#059669] border border-[#A7F3D0]",
  ...
  "partial order":       "bg-[#FFFBEB] text-[#B45309] border border-[#FDE68A]",
