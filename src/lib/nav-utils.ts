...
const PATH_META: Record<string, PathMeta> = {
  ...
  "/purchase-payment": { label: "Purchase Payment", parent: "Supply Chain" },
  "/purchase-reports": { label: "Purchase Reports", parent: "Supply Chain" },
  "/accounts-cash-bank": { label: "Finance & Banking", parent: "Accounts" },
  ...
  "/report-builder": { label: "Report Builder", parent: "Reports" },
  ...
  "/config-meal-slots": { label: "Meal Config", parent: "Configuration" },
  "/config-access-control": { label: "User Access Control", parent: "Configuration" },
