...
export const INITIAL_ROLES: Role[] = [
  ...
  },
  {
    ...
    permissions: 0,
    members:     4,
    memberList:  generateMembers({ roleCode: 'MENU_PLAN', count: 4, baseDate: '05 Jan 2025', baseAssigner: 'Business Analyst' }),
    status:      'Active',
    isSystem:    true,
    createdBy:   'System',
  ...
  },
  {
    ...
    permissions: 0,
    members:     28,
    memberList:  generateMembers({ roleCode: 'PRODUCTION', count: 28, baseDate: '05 Jan 2025', baseAssigner: 'Business Analyst' }),
    status:      'Active',
    isSystem:    true,
    createdBy:   'System',
    createdAt:   '05 Jan 2025',
    ...
    auditLog: [
      seedAudit('Created', 'System', '05 Jan 2025, 09:30 AM'),
      seedAudit('Updated', 'Business Analyst', '02 Apr 2026, 02:30 PM', 'Granted access to the new Production Entry page.'),
    ],
  },
  {
    ...
    permissions: 0,
    members:     16,
    memberList:  generateMembers({ roleCode: 'DISPATCH', count: 16, baseDate: '05 Jan 2025', baseAssigner: 'Business Analyst' }),
    status:      'Active',
    isSystem:    true,
    createdBy:   'System',
    createdAt:   '05 Jan 2025',
  ...
  },
  {
    ...
    permissions: 0,
    members:     12,
    memberList:  generateMembers({ roleCode: 'STORE_INV', count: 12, baseDate: '05 Jan 2025', baseAssigner: 'Business Analyst' }),
    status:      'Active',
    isSystem:    true,
    createdBy:   'System',
    createdAt:   '05 Jan 2025',
  ...
  },
  {
    ...
    permissions: 0,
    members:     7,
    memberList:  generateMembers({ roleCode: 'PROCUREMENT', count: 7, baseDate: '08 Jan 2025', baseAssigner: 'Business Analyst' }),
    status:      'Active',
    isSystem:    true,
    createdBy:   'System',
    ...
    auditLog: [
      ...
      seedAudit('Updated', 'Business Analyst', '01 May 2026, 11:05 AM', 'Set inheritance from Store & Inventory.', [
  ...
  },
  {
    ...
    permissions: 0,
    members:     9,
    memberList:  generateMembers({ roleCode: 'QC', count: 9, baseDate: '05 Jan 2025', baseAssigner: 'Business Analyst' }),
    status:      'Active',
    isSystem:    true,
    createdBy:   'System',
    createdAt:   '05 Jan 2025',
  ...
  },
  {
    ...
    permissions: 0,
    members:     6,
    memberList:  generateMembers({ roleCode: 'MAINTENANCE', count: 6, baseDate: '10 Jan 2025', baseAssigner: 'Business Analyst' }),
    status:      'Active',
    isSystem:    true,
    createdBy:   'System',
  ...
  },
  {
    ...
    permissions: 0,
    members:     3,
    memberList:  generateMembers({ roleCode: 'REPORTS', count: 3, baseDate: '12 Jan 2025', baseAssigner: 'Business Analyst' }),
    status:      'Active',
    isSystem:    true,
    createdBy:   'System',
